      ...
      body: ListView(
        ...
        children: [
          ...
          DropdownSearch<Province>(
            ...
            onChanged: (value) {
              FocusScope.of(context).unfocus();
              controller.provTujuanId.value = value?.id.toString() ?? "0";
            },
            popupProps: PopupProps.menu(showSearchBox: true),
            dropdownDecoratorProps: DropDownDecoratorProps(
              dropdownSearchDecoration: InputDecoration(
          ...
          DropdownSearch<City>(
            asyncItems: (String? filter) async {
              final provId = controller.provTujuanId.value;
              ...
              final response = await diogo.get(
                "https://rajaongkir.komerce.id/api/v1/destination/city/$provId",
                queryParameters: {"province": controller.provTujuanId.value},
                options: Options(
                  headers: {
                    "key": "3Avzz1W1ee866909e4d6cb0640J2Rnon",
                    "Accept": "application/json",
            ...
            onChanged: (value) {
              FocusScope.of(context).unfocus();
              controller.cityTujuanId.value = value?.id.toString() ?? "0";
            },
            popupProps: PopupProps.menu(showSearchBox: true),
            dropdownDecoratorProps: DropDownDecoratorProps(
              dropdownSearchDecoration: InputDecoration(
          ...
          DropdownSearch<District>(
            asyncItems: (String? filter) async {
              ...
              final response = await dio.get(
                "https://rajaongkir.komerce.id/api/v1/destination/district/${controller.cityTujuanId}",
                options: Options(
                  headers: {
                    "key": "3Avzz1W1ee866909e4d6cb0640J2Rnon",
                    "Accept": "application/json",
            ...
            onChanged: (value) {
              FocusScope.of(context).unfocus();
              controller.districtTujuanId.value = value?.id.toString() ?? "0";
            },
            popupProps: PopupProps.menu(showSearchBox: true),
            dropdownDecoratorProps: DropDownDecoratorProps(
              dropdownSearchDecoration: InputDecoration(
